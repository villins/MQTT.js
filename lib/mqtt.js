...
var net = require('net')
  ...
  , MqttServerClient = require('./server').MqttServerClient;
...
/**
 * createServerClient - create an MqttServerClient client
 *
 * @param {net.Socket} [stream] - stream
 * @api public
 */
module.exports.createServerClient = function(stream){
  return new MqttServerClient(stream);
}
